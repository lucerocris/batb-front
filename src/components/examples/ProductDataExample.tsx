    ...
    if (error) {
        return (
            <div className="p-4 text-red-500">
                Error: {error}
                <button onClick={refetch} className="ml-4 px-4 py-2 bg-blue-500 text-white">
                    Retry
                </button>
            </div>
        );
        ...
        <div className="p-4">
                ...
                {products.map((product) => (
                    <div key={product.id} className="border p-4 rounded">
                        ...
                        <div className="flex gap-2 mt-2">
                            <span className="px-2 py-1 bg-gray-200 text-xs">{product.color}</span>
                            <span className="px-2 py-1 bg-blue-200 text-xs">{product.type}</span>
                        </div>
            ...
            <div className="mt-8 p-4 bg-gray-100 rounded">
                ...
                <div className="mb-4">
                    ...
                    <p>{products.filter(p => p.type === 'premium').length} premium items</p>
                </div>
 ...
 *    - product.productVariants[0].stockQuantity
 * 
 * 8. Metadata:
 *    - product.createdAt
